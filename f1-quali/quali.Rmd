...
* China: Hamilton was slightly more than a second faster than Rosberg on a wet session. We also removed a qualifying session where Rosberg was two seconds faster than Hamilton.
...
Two of the outliers were mechanical failures on Hamilton's car, while the remaining two were either a driver mistake (Austria) or bad strategy (United Kingdom).
